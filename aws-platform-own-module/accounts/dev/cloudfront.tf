module "aws_cloudfront_origin_access_control" {
  ...
  name                              = module.s3_bucket_common.bucket_domain_name
...
module "aws_cloudfront_distribution" {
  ...
  target_origin_id               = module.s3_bucket_common.bucket_domain_name                     
  ...
  domain_name                    = module.s3_bucket_common.bucket_domain_name                     
  origin_access_control_id       = module.aws_cloudfront_origin_access_control.id                 #"E4BBT3R5TXZUH"
  origin_id                      = module.s3_bucket_common.bucket_domain_name                     
  ...
  domain_name_1                  = module.s3_core_common_cdn_data.bucket_domain_name              
  origin_access_control_id_1     = module.aws_cloudfront_origin_access_control.id                 
...
module "aws_cloudfront_origin_access_control_core_common_cdn_data" {
  source                            = "../../modules/cloudfront/cloudfront_origin_access_control"
  name                              = module.s3_core_common_cdn_data.bucket_domain_name          
